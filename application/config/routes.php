...
$route['users/student/form-success/(:num)/(:any)'] = 'users_student/success_page/$1/$2';
...
$route['users/faculty/form-success/(:num)/(:any)'] = 'users_faculty/success_page/$1/$2';
...
$route['users/staff/form-success/(:num)/(:any)'] = 'users_staff/success_page/$1/$2';
...
$route['reports/student/download/(:any)/(:any)/(:any)/(:any)/(:any)/(:num)/(:any)'] = 'reports_student/download/$1/$2/$3/$4/$5/$6/$7';
