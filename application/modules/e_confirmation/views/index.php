...
document.addEventListener('DOMContentLoaded', function() {
	...
	new Vue({
	    ...
	    data: {
	    	...
	    	page:{
		    	show: '<?php echo base_url() ?>e-confirmation/show'
	    	},
	    ...
	    methods: {
	        ...
	        fetchData(page) {
	        	...
	        	this.loading = true
	        	this.msg = false
	        	this.$http.get('<?php echo base_url() ?>e_confirmation/read/'+this.option+'/'+this.value + '/' + page + '/' + this.per_page)
	        	.then(response => {
