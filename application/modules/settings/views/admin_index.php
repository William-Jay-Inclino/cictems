...
<section id="app" class="section" v-cloak>
	<div class="container" style="max-width: 600px">
		...
		<div class="box">
			...
			<br>
			<h6 class="title is-6 is-note">Enrollment</h6>
			<table class="table is-fullwidth">
				<tr :class="{'active-input': editEnrol}">
					<td width="45%">
						<b>Password</b> <br>
						<p class="help is-note">Is used for activation/deactivation and for students that failed the evaluation</p>
					</td>
					<td width="45%">
						<span v-if="editEnrol">
							<input type="password" v-model.trim="form.curPass2" class="input" placeholder="Current" @keyup.enter="save('enrolPass')" autofocus="true"> 
							<p class="help dang-msg"> {{error.curPass2}} </p>
							<br>
							<input type="password" v-model.trim="form.newPass2" class="input" placeholder="New" @keyup.enter="save('enrolPass')" @keyup="newpass_checker(1)">
							<p class="help is-note" v-html="newPass_msg2"></p>
							<br>
							<input type="password" v-model.trim="form.conPass2" class="input" placeholder="Retype new" @keyup.enter="save('enrolPass')"  @keyup="conpass_checker(1)">
							<p class="help" v-html="conPass_msg2"></p>
							<p class="help is-note">
								<i class="fa fa-circle fa-sm"></i> Passwords must have atleast eight characters. 
							</p>
							<p class="help is-note">
								<i class="fa fa-circle fa-sm"></i> Passwords must use atleast three of the four available character types: <b> lowercase letters, uppercase letters, numbers, and symbols. </b> 
							</p>
							<hr>
							<button class="button is-link is-small" @click="save('enrolPass')" :disabled="pw_has_error2">Save Changes</button>
							<br><br>
						</span>						
						<span v-else>
							<i class="fa fa-circle fa-sm" v-for="n in 8"></i>
					...
					<td width="10%">
						<span v-if="editEnrol">
							<button class="button is-small" @click="editEnrol = false"><i class="fa fa-times has-text-danger"></i></button>
						</span>
						<span v-else>
							<button class="button is-small" @click="focus('enrol')"><i class="fa fa-pencil"></i></button>
						</span>
					</td>
				</tr>
			</table>
