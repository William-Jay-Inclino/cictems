...
document.addEventListener('DOMContentLoaded', function() {
	...
	new Vue({
	    ...
	    data: {
	    	...
	    	page:{
		    	data_list: 'Prospectus list',
		    	add: 'Add Prospectus',
		    	add_link: '<?php echo base_url() ?>maintenance/prospectus/form',
		    	show: '<?php echo base_url() ?>maintenance/prospectus/show'
	    	},
    		...
    		option: 'p.prosCode',
    		search_options: [
    			{value: 'p.prosCode', text: 'Code'},
    			{value: 'p.prosDesc', text: 'Description'}
    		],
	    ...
	    methods: {
	        ...
	        fetchData(page) {
	        	...
	        	this.loading = true
	        	this.msg = false
	        	this.$http.get('<?php echo base_url() ?>maintenance_prospectus/read/'+this.option+'/'+this.value + '/' + page + '/' + this.per_page)
	        	.then(response => {
