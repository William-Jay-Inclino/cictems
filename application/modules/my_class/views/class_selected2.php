...
<section id="app" class="section" v-cloak>
	<div class="container">
		...
		<button class="button is-link is-pulled-right" v-on:click="finGrade" v-if="show_buttons">Finalize Grades</button>
		...
		<div v-if="show_buttons">
			<a :href="'<?php echo base_url() ?>my-class/update-grade/prelim/' + classID" class="button is-primary">Prelim</a>
			<a :href="'<?php echo base_url() ?>my-class/update-grade/midterm/' + classID" class="button is-primary">Midterm</a>
			<a :href="'<?php echo base_url() ?>my-class/update-grade/prefi/' + classID" class="button is-primary">Semi-finals</a>
			<a :href="'<?php echo base_url() ?>my-class/update-grade/final/' + classID" class="button is-primary">Finals</a>
			<br><br>
		</div>
			...
			<div class="box">
				<table class="table is-fullwidth is-centered">
					...
					<tr v-for="student in students">
						...
						<td>
							<a :href="'<?php echo base_url() ?>my-class/student-grade' + '/' + classID + '/' + student.studID" class="button is-outlined is-primary"><i class="fa fa-angle-double-right fa-lg"></i></a>
						</td>
					</tr>
				</table>
			</div>
