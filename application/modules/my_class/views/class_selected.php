			...
			<div class="box">
				...
				<table class="table is-fullwidth is-centered">
					...
					<tr v-for="student,i in students">
						...
						<td>
							<multiselect :disabled="is_disabled(i, student.prelim)" :show-no-results="false" v-bind="override" :options-limit="2" v-model="student.prelim" track-by="grade" label="grade" :options="grades" placeholder="" @input="saveGrade(i,'p')" :loading="student.prelim_loader"></multiselect>
						</td>
						<td>
							<multiselect :disabled="is_disabled(i, student.midterm)" :show-no-results="false" v-bind="override" :options-limit="2" v-model="student.midterm" track-by="grade" label="grade" :options="grades" placeholder="" @input="saveGrade(i,'m')" :loading="student.midterm_loader"></multiselect>
						</td>
						<td>
							<multiselect :disabled="is_disabled(i, student.prefi)" :show-no-results="false" v-bind="override" :options-limit="2" v-model="student.prefi" track-by="grade" label="grade" :options="grades" placeholder="" @input="saveGrade(i,'sf')" :loading="student.prefi_loader"></multiselect>
						</td>
						<td>
							<multiselect :disabled="is_disabled(i, student.final)" :show-no-results="false" v-bind="override" :options-limit="2" v-model="student.final" track-by="grade" label="grade" :options="grades" placeholder="" @input="saveGrade(i,'f')" :loading="student.final_loader"></multiselect>
						</td>
	...
	new Vue({
	    ...
	    methods: {
	    	...
	    	fetch_Class_Selected(){
	    		this.$http.get('<?php echo base_url() ?>my_class/fetch_Class_Selected/'+this.classID)
	            .then(response => {
	    	...
	    	fetch_Students(){
	    		this.$http.get('<?php echo base_url() ?>my_class/fetch_Students/'+this.classID)
	            .then(response => {
