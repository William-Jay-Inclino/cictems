		...
		new Vue({
			...
			methods:{
		    	fetch_Students_in_Class(){
		    		this.$http.get('<?php echo base_url() ?>my_class/fetch_Students_in_Class/'+this.grading+'/'+this.classID)
		            .then(response => {
		               this.students = response.body
		            })
		    	},
		    	submitForm(){
		    		this.$http.post('<?php echo base_url() ?>my_class/update_by_group',{students: this.students, classID: this.classID, grading: this.grading})
		            .then(response => {
