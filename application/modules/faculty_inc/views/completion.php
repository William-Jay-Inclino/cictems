	...
	<div class="container">
		<nav class="breadcrumb has-bullet-separator" aria-label="breadcrumbs">
		  <ul>
		    ...
		    <li><a :href="'<?php echo base_url() ?>inc-grades/classes/' + studID">Incomplete Classes</a></li>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	new Vue({
	    ...
	    methods: {
	    	get_grades(){
	    		this.$http.get('<?php echo base_url() ?>faculty_inc/get_grades/'+this.classID+'/'+this.studID)
	            .then(response => {
	    	...
	    	comply(){
	    		if(this.checkForm()){
	    			...
	    			this.$http.post('<?php echo base_url() ?>faculty_inc/comply', data)
		            .then(response => {
		               console.log(response.body)
		               const c = response.body
		               this.fg = c.fg
