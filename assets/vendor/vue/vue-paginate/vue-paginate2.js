! function(e, t) {
    ...
    return function(e) {
        ...
        function s(e, t) {
            for (var n = 0; n < e.length; n++) {
                ...
                if (a) {
                    ...
                    for (; i < s.parts.length; i++) a.parts.push(o(s.parts[i], t))
                } else {
                    for (var r = [], i = 0; i < s.parts.length; i++) r.push(o(s.parts[i], t));
                    d[s.id] = {
                        id: s.id,
                        refs: 1,
                        parts: r
        ...
        function i(e, t) {
            var n = g(),
                s = C[C.length - 1];
            if ("top" === e.insertAt) s ? s.nextSibling ? n.insertBefore(t, s.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), C.push(t);
            else {
        ...
        function o(e, t) {
            ...
            if (t.singleton) {
                var i = h++;
                n = v || (v = l(t)), s = c.bind(null, n, i, !1), a = c.bind(null, n, i, !0)
            } else n = l(t), s = u.bind(null, n), a = function() {
                r(n)
            };
            return s(e),
                function(t) {
                    ...
                    if (this.pageCount <= this.pageRange)
                        for (var n = 0; n < this.pageCount; n++) {
                            ...
                            for (var a = Math.floor(this.pageRange / 2), i = function(n) {
                                    ...
                                    t[e] = n
                                }, l = 0; l < this.marginPages; l++) i(l);
                            var o = 0;
                            this.selected - a > 0 && (o = this.selected - a);
                            var c = o + this.pageRange - 1;
                            c >= this.pageCount && (c = this.pageCount - 1, o = c - this.pageRange + 1);
                            for (var u = o; u <= c && u <= this.pageCount - 1; u++) i(u);
                            o > this.marginPages && r(o - 1), c + 1 < this.pageCount - this.marginPages && r(c + 1);
        ...
        e.exports = {
            render: function() {
                ...
                }, [e._v(e._s(e.firstButtonText))]) : e._e(), e._v(" "), e.firstPageSelected() && e.hidePrevNext ? e._e() : n("a", {
                ...
                }, [e._v(e._s(e.firstButtonText))])]) : e._e(), e._v(" "), e.firstPageSelected() && e.hidePrevNext ? e._e() : n("li", {
