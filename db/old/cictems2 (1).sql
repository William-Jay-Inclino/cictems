...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2018 at 12:50 PM
...
(1, 45, 4, 7, 1, 25, 1, '*ENGLISH 01', '19:30:00', '20:30:00', 'unlocked', '2018-10-20 10:03:51'),
(2, 45, 5, 8, 2, 25, 1, 'ENGLISH 1', '08:30:00', '09:30:00', 'unlocked', '2018-10-20 10:03:51'),
(3, 45, 6, 10, 4, 25, 1, 'MATH 1', '09:30:00', '10:30:00', 'unlocked', '2018-10-20 10:03:51'),
(4, 45, 7, 11, 5, 25, 1, 'IT 1', '10:30:00', '11:30:00', 'unlocked', '2018-10-20 10:03:51'),
(5, 45, 8, 7, 7, 25, 1, 'IT 2', '13:00:00', '15:00:00', 'unlocked', '2018-10-20 10:03:51'),
(6, 45, 9, 12, 7, 25, 1, 'KB 1', '16:00:00', '17:00:00', 'unlocked', '2018-10-20 10:03:51'),
(7, 45, 10, 14, 8, 25, 2, 'PE 1', '07:30:00', '08:30:00', 'unlocked', '2018-10-20 10:03:51'),
(8, 45, 11, 12, 10, 25, 2, 'NSTP 1', '09:00:00', '10:30:00', 'unlocked', '2018-10-20 10:03:51'),
(9, 45, 12, 14, 2, 25, 2, 'FILIPINO 1', '13:00:00', '14:30:00', 'unlocked', '2018-10-20 10:03:51');
...
INSERT INTO `faculty` (`facID`, `uID`, `specialization`) VALUES
(1, 44, 'English teacher'),
(2, 45, 'English teacher'),
(4, 52, 'English teacher'),
(5, 53, 'Filipino teacher'),
(6, 57, 'Filipino teacher'),
(7, 77, 'Filipino teacher'),
(8, 78, 'Filipino teacher'),
(9, 79, 'Math teacher'),
(10, 80, 'Math teacher'),
(11, 81, 'Math teacher'),
(12, 82, 'IT teacher'),
...
INSERT INTO `fees` (`feeID`, `termID`, `feeName`, `feeDesc`, `dueDate`, `feeStatus`) VALUES
(1, 24, 'Intrams', 'Intramurals deesc', '2018-08-07', 'ongoing'),
(2, 24, 'Christmas party', 'christmas description', '2018-08-18', 'ongoing');

-- --------------------------------------------------------

--
-- Table structure for table `fee_breakdown`
--

CREATE TABLE `fee_breakdown` (
  `fbreakID` int(11) NOT NULL,
  `feeID` int(11) NOT NULL,
  `breakDesc` varchar(20) NOT NULL,
  `breakAmount` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `fee_breakdown`
--

INSERT INTO `fee_breakdown` (`fbreakID`, `feeID`, `breakDesc`, `breakAmount`) VALUES
(1, 2, 'cater', '500.00'),
(2, 2, 'gifts', '200.00'),
(3, 1, 'tshirt', '300.00'),
(4, 1, 'contestants attire', '150.00');
...
(10, 1, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(11, 2, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(12, 3, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(13, 4, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(14, 5, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(15, 6, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(16, 7, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(17, 8, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48'),
(18, 9, 46, '', '', '', '', '', '', '', 'Unenrolled', '2018-10-20 18:20:48');
...
INSERT INTO `subject` (`subID`, `prosID`, `yearID`, `semID`, `subCode`, `subDesc`, `lec`, `lab`) VALUES
(4, 3, 1, 1, '*ENGLISH 01', 'English Plus', 3, 0),
(5, 3, 1, 1, 'ENGLISH 1', 'Communication Arts 1', 3, 0),
(6, 3, 1, 1, 'MATH 1', 'College Algebra', 3, 0),
(7, 3, 1, 1, 'IT 1', 'IT Fundamentals', 3, 0),
(8, 3, 1, 1, 'IT 2', 'Computer Programming 1', 3, 3),
(9, 3, 1, 1, 'KB 1', 'Keyboarding 1', 0, 3),
(10, 3, 1, 1, 'PE 1', 'Physical Fitness 1', 2, 0),
(11, 3, 1, 1, 'NSTP 1', 'National Service Training Program', 3, 0),
(12, 3, 1, 1, 'FILIPINO 1', 'Sining ng Pakikipagtalastasan', 3, 0),
(13, 3, 1, 2, 'ENGLISH 2', 'Communications for IT', 3, 0),
(14, 3, 1, 2, 'IT3', 'Computer Programming 2', 3, 3),
(15, 3, 1, 2, 'IT 4', 'Presentation Skills in IT', 3, 0),
(16, 3, 1, 2, 'Math 2', 'Trigonometry', 3, 0),
(17, 3, 1, 2, 'IT 5', 'Fundamentals of Problem Solving', 3, 0),
(18, 3, 1, 2, 'KB 2', 'Keyboarding 2', 0, 3),
(19, 3, 1, 2, 'PE 2', 'Rhythmic Activities', 2, 0),
(20, 3, 1, 2, 'NSTP 2', 'National Service Training Program 2', 3, 0),
(21, 3, 2, 1, 'PHYSICS 1', 'Mechanics and Thermodynamics', 3, 0),
(22, 3, 2, 1, 'IT 6', 'Computer and File Organization', 3, 0),
(23, 3, 2, 1, 'IT 7', 'Object-Oriented Programming', 3, 3),
(24, 3, 2, 1, 'IT 8', 'Operating System Application', 3, 0),
(25, 3, 2, 1, 'MATH 3', 'Discrete Structures', 3, 0),
(26, 3, 2, 1, 'ENGLISH 3', 'Speech and Oral Communication', 3, 0),
(27, 3, 2, 1, 'SOC SCI 1', 'General Psychology with Drug Prevention', 3, 0),
(28, 3, 2, 1, 'PE 3', 'Individual Sports', 2, 0),
(29, 3, 2, 1, 'HUMANITIES 1', 'Art, Man and Society', 3, 0),
(30, 3, 2, 2, 'PHYSICS 2', 'Electricity and Magnetism', 3, 0),
(31, 3, 2, 2, 'IT-ELE 1', 'Data Comm. and Computer Networks', 3, 0),
(32, 3, 2, 2, 'IT 9', 'Database Management System 1', 2, 1),
(33, 3, 2, 2, 'IT-ELE 2', 'Web Page Design', 2, 1),
(34, 3, 2, 2, 'IT 10', 'Systems Analysis', 3, 0),
(35, 3, 2, 2, 'MATH 4', 'Probability and Statistics', 3, 0),
(36, 3, 2, 2, 'SOC SCI 2', 'Professional Ethics with Values Formation', 3, 0),
(37, 3, 2, 2, 'ENGLISH 4', 'Business English', 3, 0),
(38, 3, 2, 2, 'PE 4', 'Team Sports', 2, 0),
(39, 3, 3, 1, 'IT-ELE 3', 'Computer Animation', 2, 1),
(40, 3, 3, 1, 'IT 11', 'Database Management System 2', 2, 1),
(41, 3, 3, 1, 'IT 12', 'Modelling and Simulation', 3, 0),
(42, 3, 3, 1, 'IT 13', 'Management Information System', 3, 0),
(43, 3, 3, 1, 'ECO 1', 'Economics w/ Taxation', 3, 0),
(44, 3, 3, 1, 'HUMANITIES 2', 'Philippine Literature', 3, 0),
(45, 3, 3, 1, 'ACCOUNTING 1', 'Accounting Principles', 3, 0),
(46, 3, 3, 1, 'IT 14', 'Quality Conciousness, habits', 3, 0),
(47, 3, 3, 2, 'IT 15', 'Software Engineering', 2, 1),
(48, 3, 3, 2, 'IT 16', 'Multimedia System', 0, 3),
(49, 3, 3, 2, 'IT-ELE 4', 'Mobile Applicatoins Development', 2, 1),
(50, 3, 3, 2, 'IT-ELE 5', 'Project Management', 3, 0),
(51, 3, 3, 2, 'FREE-ELE 2', 'Busines Systems', 3, 0),
(52, 3, 3, 2, 'FREE-ELE 1', 'Dynamic Web Applications', 2, 1),
(54, 3, 3, 3, 'IT PRAC', 'Practicum/OJT', 9, 0),
(55, 3, 4, 1, 'IT PRO', 'IT Proposal', 6, 0),
(56, 3, 4, 1, 'FREE-ELE 3', 'Computer Graphics', 0, 3),
(57, 3, 4, 1, 'IT-SEMINAR', 'Seminars', 3, 0),
(58, 3, 4, 1, 'FREE-ELE 4', 'Digital Design', 3, 0),
(59, 3, 4, 1, 'IT 17', 'Information System Security', 2, 1),
(60, 3, 4, 2, 'IT 18', 'Software Integration', 3, 0),
(61, 3, 4, 2, 'IT 19', 'Capstone Project (IT Thesis)', 3, 3),
(62, 3, 4, 2, 'FREE-ELE 5', 'PHILNITS', 0, 3),
(63, 3, 4, 2, 'IT 20', 'Internet Programming with Database', 2, 1),
(64, 3, 4, 2, 'RIZAL COURSE', 'Life and Works of Rizal', 3, 0),
(65, 1, 3, 2, 'IT 4', 'Presentation Skill in IT', 3, 0),
(66, 1, 2, 2, 'SOC SCI 2', 'Professional Ethics with Values Formation', 0, 3),
(67, 4, 4, 2, 'FREE-ELE 5', 'PHILNITS', 0, 3),
(68, 4, 1, 2, 'CS 4', 'Data Structure', 3, 0),
(69, 5, 5, 2, 'RIZAL COURSE', 'Life & Works of Rizal', 3, 0),
(70, 5, 2, 2, 'SOC SCI 2', 'Society & Culture w/ Family Planning', 3, 0);
...
(24, 2, '2017-2018', 'inactive'),
(45, 1, '2017-2018', 'active'),
...
(6, 4, 'Banez', 'Angel123', 'Angel Jean', 'Quinte', 'Banez', '1999-01-20', 'Female', 'Casilda', '09106024370', 'agnel@gmail.com', 'active', 'yes', '2018-10-11 11:37:48'),
(43, 4, 'Wills', 'Iamwilliam1', 'William Jay', 'Intales', 'Inclino', '1997-10-24', 'Male', 'Puertoello', '0921212121', '', 'active', 'yes', '2018-10-11 11:38:28'),
(44, 2, 'jojo', 'Iamjojo1', 'Joscoro', '', 'Cantero', '1981-08-27', 'Male', 'Sanjuan, Ormoc City', '09172625491', 'jojocads@gmail.com', 'active', 'no', '2018-10-09 11:47:13'),
(45, 2, 'Mark123', 'Iammark1', 'Mark', '', 'Bernardo', '1994-06-28', 'Male', 'Ambot', '091212121121', '', 'active', 'no', '2018-10-09 11:47:13'),
(46, 4, 'Pacala', 'Raffy123', 'Raffy', '', 'Pacala', '1998-09-23', 'Male', 'Isabel', '09121212121', 'Raf@yahoo.com', 'active', 'yes', '2018-10-11 11:38:51'),
(47, 3, 'angelica', 'Angelica1', 'Angelica', '', 'Prawn', '1999-09-27', 'Female', 'Ormoc City', '09121212228', 'angelica@gmail.com', 'active', 'no', '2018-10-09 12:48:58'),
(48, 4, '', '', 'Rhayjay', '', 'Alag', '1997-12-22', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:39:16'),
(49, 4, '', '', 'Julito', '', 'Caquilala', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-10 00:02:28'),
(52, 2, 'Martinez', 'Martinez1', 'Martin', '', 'Martinez', '2008-09-26', 'Male', '', '09212111111', 'martin@yahoo.com', 'active', 'no', '2018-10-09 23:16:22'),
(53, 2, 'Quirino', '111', 'Jhay', '', 'Quirino', '2012-10-28', 'Male', '', '', 'rod@yahoo.com', 'active', 'yes', '2018-10-11 11:54:38'),
(54, 3, 'Passion', 'Passion1', 'Reyjoy', '', 'Passion', '2008-09-23', 'Male', 'Ormoc city', '09876212111', 'rey@gmail.com', 'active', 'no', '2018-10-10 00:20:38'),
(57, 2, 'Isip', 'Apple123', 'Apple', '', 'Isip', '1999-05-22', 'Female', 'Ormoc', '09121111111', 'ape@gmail.com', 'active', 'no', '2018-10-10 00:51:45'),
(58, 4, '', '', 'Joshua', '', 'Tayag', '1998-09-28', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:41:22'),
(59, 4, '', '', 'Joseph', '', 'Estrera', '1999-02-12', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:42:01'),
(60, 4, '', '', 'Mitzi', '', 'Yap', '1998-12-08', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:42:32'),
(61, 4, '', '', 'Scyth', '', 'Badayos', '1996-07-22', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:42:59'),
(62, 4, '', '', 'Angel', '', 'Bestil', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:43:30'),
(63, 4, '', '', 'Merzon', '', 'Albarico', '1996-01-06', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:44:06'),
(64, 4, '', '', 'Maricon', '', 'Daffon', '1997-11-11', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:44:42'),
(65, 4, '', '', 'Mayette', '', 'Bulahan', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:45:12'),
(66, 4, '', '', 'Jomari', '', 'Bunye', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:46:30'),
(67, 4, '', '', 'Mercy Jane', '', 'Lapinid', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:46:55'),
(68, 4, '', '', 'Jorge', '', 'Mendoza', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:47:20'),
(69, 4, '', '', 'Karl', '', 'Laurente', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:48:16'),
(70, 4, '', '', 'Jowanos', '', 'Alcala', '1999-08-09', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:49:14'),
(71, 4, '', '', 'Bonbon', '', 'Inclino', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:49:49'),
(72, 4, '', '', 'Khenny', '', 'Sumile', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:50:43'),
(73, 4, '', '', 'Avegiel', '', 'Libres', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:51:03'),
(74, 4, '', '', 'lemarie', '', 'Bongbong', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-11 11:51:39'),
(75, 4, '', '', 'Jaboy', '', 'Banzal', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:52:03'),
(76, 4, '', '', 'Luis', '', 'Magalona', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-11 11:52:24'),
(77, 2, 'Cohat', '614890', 'Alexander', '', 'Cohat', '1988-09-20', 'Male', '', '', 'alex@gmail.com', 'active', 'yes', '2018-10-11 11:53:30'),
(78, 2, 'Tarre', '564281', 'Cheryl', '', 'Tarre', '1991-12-09', 'Female', '', '', 'cheryl@gmail.com', 'active', 'yes', '2018-10-11 11:54:24'),
(79, 2, 'Bertulfo', '156284', 'Edward', '', 'Bertulfo', '1996-12-02', 'Male', '', '', 'Eddy@gmail.com', 'active', 'yes', '2018-10-11 11:55:08'),
(80, 2, 'Lopez', '482091', 'Jotham', '', 'Lopez', '1991-08-02', 'Male', '', '', 'Jotham@gmail.com', 'active', 'yes', '2018-10-11 12:02:48'),
(81, 2, 'Fiel', '639702', 'Myra', '', 'Fiel', '1995-10-28', 'Female', '', '', 'Myra@yahoo.com', 'active', 'yes', '2018-10-11 12:03:19'),
(82, 2, 'Phua', '968401', 'Wowhie', '', 'Phua', '1981-07-22', 'Male', '', '', 'wow@yahoo.com', 'active', 'yes', '2018-10-11 12:06:10'),
(83, 4, '', '', 'Anikka', '', 'Balancio', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-14 05:27:08'),
(84, 4, '', '', 'Dave', '', 'Camasura', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-14 05:27:28'),
(85, 4, '', '', 'Rhea', '', 'Laurente', '0000-00-00', 'Female', '', '', '', 'active', 'yes', '2018-10-14 05:35:30'),
(86, 4, '', '', 'Kevin', '', 'Aying', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-14 05:36:09'),
(87, 4, '', '', 'Kyle', '', 'Aying', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-14 05:36:28'),
(88, 4, '', '', 'Axl', '', 'Aliasot', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-14 05:38:17'),
(89, 4, '', '', 'Ken', '', 'Cormanes', '0000-00-00', 'Male', '', '', '', 'active', 'yes', '2018-10-14 05:47:00'),
(93, 2, 'Gablino', '482091', 'Chebang', '', 'Gablino', '1988-08-11', 'Male', '', '', 'chevang@gmail.com', 'active', 'yes', '2018-10-18 02:59:39'),
(94, 2, 'Leones', '109275', 'Maria', '', 'Leones', '1972-02-02', 'Female', '', '', 'lion@gmail.com', 'active', 'yes', '2018-10-18 03:00:29'),
(95, 2, 'Dizon', '432590', 'Bebot', '', 'Dizon', '1989-09-08', 'Male', '', '', 'bebot@gmail.com', 'active', 'yes', '2018-10-18 03:01:00');
...
--
-- Indexes for table `fee_breakdown`
--
ALTER TABLE `fee_breakdown`
  ADD PRIMARY KEY (`fbreakID`),
  ADD KEY `feeID` (`feeID`);
...
--
ALTER TABLE `counter2`
  MODIFY `countID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `faculty`
  MODIFY `facID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
-- AUTO_INCREMENT for table `fee_breakdown`
--
ALTER TABLE `fee_breakdown`
  MODIFY `fbreakID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `accounts`
  ADD CONSTRAINT `accounts_ibfk_1` FOREIGN KEY (`studID`) REFERENCES `student` (`studID`);
...
--
-- Constraints for table `fee_breakdown`
--
ALTER TABLE `fee_breakdown`
  ADD CONSTRAINT `fee_breakdown_ibfk_1` FOREIGN KEY (`feeID`) REFERENCES `fees` (`feeID`);
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`fbreakID`) REFERENCES `fee_breakdown` (`fbreakID`),
