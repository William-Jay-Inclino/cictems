...
(1, 24, 60, 7, 28, 39, 1, 'IT 18', '07:00:00', '08:00:00', 'unlocked', '2018-11-15 11:45:57');
...
(1, 24, 'Thesis Capstone Final Defense', 'BSIT, BSCS 4th year and BSCPE 5th year students', '3500.00', '2018-11-29', 'ongoing'),
(2, 24, 'Christmas Party 2k18', 'All students', '500.00', '2018-11-30', 'ongoing'),
(5, 24, 'x', 'x', '555.00', '2016-10-27', 'ongoing');
...
INSERT INTO `stud_fee` (`sfID`, `studID`, `feeID`, `balance`) VALUES
(64, 53, 5, '555.00'),
(65, 62, 5, '555.00'),
(66, 52, 5, '555.00'),
(67, 43, 5, '555.00');
...
--
ALTER TABLE `stud_fee`
  MODIFY `sfID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
--
