...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2019 at 09:27 AM
...
(189, 8, 4, 1, 20, 'CpE-AO411', 'Computer Architecture &', 3, 3, 'lec', '', 713),
(190, 8, 4, 1, 20, 'CpE-AO411', 'Computer Architecture &', 3, 3, 'lab', '', 713),
(191, 8, 4, 1, 20, 'CpE-ELE411', 'Robot Design', 3, 3, 'lec', '', 391),
(192, 8, 4, 1, 20, 'CpE-ELE411', 'Robot Design', 3, 3, 'lab', '', 391),
(193, 8, 4, 2, 20, 'CpE-ProjDe421', 'CpE Practice and Design 2', 3, 6, 'lec', '', 367),
(194, 8, 4, 2, 20, 'CpE-ProjDe421', 'CpE Practice and Design 2', 3, 6, 'lab', '', 367),
...
--
ALTER TABLE `subject`
  MODIFY `subID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;

--
-- AUTO_INCREMENT for table `subject_req`
--
ALTER TABLE `subject_req`
  MODIFY `subReqID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;
