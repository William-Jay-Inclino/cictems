...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2019 at 12:02 PM
...
(2, 53, 14, 29, 39, 27, 1, 'STS121', '09:00:00', '10:00:00', 0, 'unlocked', '2019-02-13 05:06:16'),
...
(9, 53, 21, 34, 38, 27, 2, 'Hist121', '16:30:00', '18:00:00', 0, 'unlocked', '2019-02-13 03:18:29'),
...
(10, 9, 1, '', '', '', '', '', '', '', 'Enrolled', '2019-02-13 11:19:33'),
...
(13, 2, 1, '80.00', '88.00', 'Dropped', '', '63.6', 'Dropped', '', 'Enrolled', '2019-02-13 13:17:22'),
(14, 2, 3, '', '', '', '', '', '', '', 'Enrolled', '2019-02-13 13:24:14'),
...
(23, 9, 3, '', '', '', '', '', '', '', 'Enrolled', '2019-02-13 13:24:14'),
...
(1, 1, 'admin', 'Iamadmin1', 'Cheryl', '', 'Tarre', '1997-10-24', 'Female', 'Kalimot ko street', '9343438534', 'cheryl@gmail.com', 'active', 'no', '2019-02-13 02:46:17'),
...
--
ALTER TABLE `studclass`
  MODIFY `scID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `studgrade`
  MODIFY `sgID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `stud_fee`
  MODIFY `sfID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `users`
  MODIFY `uID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
